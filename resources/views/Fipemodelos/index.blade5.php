    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                Modelos de Veiculos <small>({{ $fipe_modelos['codigo_fipe'] }})</small>
            </div>
            <div class="card-body">
                ...
                <div class="box-body">
                    ...
                    <article class="mb-3">
                          <div class="custom-control custom-checkbox">
                              ...
                              <label class="custom-control-label" for="estaSelecionado-{{ $fipe_modelo['codigo_fipe'] }}-{{ $fipe_modelo['ano_modelo'] }}"><h4>{{ $fipe_modelo['modelo_desc'] }} </h4></label>
                          </div>
                          <div id="confirmacao-{{ $fipe_modelo['codigo_fipe'] }}-{{ $fipe_modelo['ano_modelo'] }}" style="display:none">O checkbox está selecionado</div>
                        <p class="m-0">{{ $fipe_modelo['codigo_fipe'] }}</body>
